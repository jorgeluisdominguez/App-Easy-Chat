...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        usernameInput = binding.profileUsername;
        profilePic = binding.profileImageView;
        phoneInput = binding.profilePhone;
        updateProfileBtn = binding.profleUpdateBtn;
        progressBar = binding.profileProgressBar;
        logoutBtn = binding.logoutBtn;

        //1er obtner los datos del usuario
        getUserData();
    ...
    public void updateBtnClick(){
        ...
        //actualziar el nombre del usuario
    ...
    public void updateToFirestore(){
        FirebaseUtil.currentUserDetails().set(currentUserModel)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()){
                        setInProgress(false);
                        Toast.makeText(getContext(), "Se actualizó con éxito", Toast.LENGTH_SHORT).show();
                    }else {
    ...
    public void getUserData(){
        setInProgress(true); //barra de progeso mientras carga
        ...
        FirebaseUtil.currentUserDetails().get().addOnCompleteListener(task -> {
            if (task.isSuccessful()){
                setInProgress(false); //barra de progeso mientras carga
